...
async def raccolta_dati(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        try:
            ...
            # Dati completi — modifica Canva
            await update.message.reply_text("Modifico il template su Canva...")
            ...
            if url:
                msg = (
                    f"Preventivo pronto!\n\n"
                    f"Apri su Canva: {url}\n\n"
                    f"Da li aggiungi la foto della location e scarichi il PDF."
                )
            else:
                msg = (
                    f"Dati elaborati correttamente!\n\n"
                    f"Sposi: {dati['sposi']}\n"
                    f"Data: {dati['data_evento']}\n"
                    f"Location: {dati['location']}\n"
                    f"Totale: {dati['totale']}\n\n"
                    f"Il token Canva non e configurato. Apri il template su Canva e aggiorna manualmente."
                )
